    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('Aún no hay datos suficientes', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
          const Text('Tus métricas aparecerán aquí conforme recibas visitas.'),
        ],
      ),
    );
  }
